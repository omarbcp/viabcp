...
var Swiper = (function () {
    ...
    var N = {
        ...
        slidePrev: function (e, t, s) {
            ...
            if (
                (void 0 !== f &&
                    ((g = n.indexOf(f)), g < 0 && (g = a.activeIndex - 1), "auto" === i.slidesPerView && 1 === i.slidesPerGroup && i.slidesPerGroupAuto && ((g = g - a.slidesPerViewDynamic("previous", !0) + 1), (g = Math.max(g, 0)))),
                ...
                if (x.length > 0 && L) {
                    if (void 0 === t) {
                        ...
                        o
                            ...
                            : (d.slideTo(C + Math.ceil(I), 0, !1, !0), i && ((d.touchEventsData.startTranslate = d.touchEventsData.startTranslate - t), (d.touchEventsData.currentTranslate = d.touchEventsData.currentTranslate - t)));
                    } else if (i) {
                    ...
                    if (void 0 === t) {
                        ...
                        o
                            ? d.setTranslate(d.translate - t)
                            : (d.slideTo(C - z, 0, !1, !0), i && ((d.touchEventsData.startTranslate = d.touchEventsData.startTranslate - t), (d.touchEventsData.currentTranslate = d.touchEventsData.currentTranslate - t)));
                    } else {
            ...
            function L(e) {
                ...
                if (((m = !1), (h = !1), g.push(e), !(g.length < 2))) {
                    if (((m = !0), (v.scaleStart = T()), !v.slideEl)) {
                        ...
                        if ((a && (a = a.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), (v.imageEl = a), (v.imageWrapEl = a ? E(v.imageEl, `.${s.containerClass}`)[0] : void 0), !v.imageWrapEl))
                ...
                (s.scale = A || $),
                    ...
                    !e || (1 === l && A)
                        ...
                        : ((L = v.slideEl.offsetWidth),
                          ...
                          (C = -S),
                          (P = -T),
                          z > 0 && A && "number" == typeof b.currentX && "number" == typeof b.currentY ? ((u = (b.currentX * s.scale) / z), (m = (b.currentY * s.scale) / z)) : ((u = c * s.scale), (m = p * s.scale)),
                          u < S && (u = S),
                          u > C && (u = C),
                          m < T && (m = T),
                          m > P && (m = P)),
